...
class MyAttention(nn.Module):
    ...
    def forward(self, x, x_source, loc_source, H, W, conf_source=None):
        ...
        k = h * w
        delta = self.delta_fc(x_source[:, :k, :])
...
@register_model
def mypvt20_9a_small(pretrained=False, **kwargs):
    model = MyPVT(
...
if __name__ == '__main__':
    ...
    model = mypvt20_9a_small(drop_path_rate=0.1).to(device)
