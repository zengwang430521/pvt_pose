...
@register_model
def pvt_nano_impr1_peg(pretrained=False, **kwargs):
...
@register_model
def pvt_tiny_impr1_peg(pretrained=False, **kwargs):
    model = PyramidVisionTransformerImpr_PEG(
...
@register_model
def pvt_medium_impr1_peg(pretrained=False, **kwargs):
    model = PyramidVisionTransformerImpr_PEG(
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
...
@register_model
def pvt_huge_impr1_peg(pretrained=False, **kwargs):
    model = PyramidVisionTransformerImpr_PEG(
...
@register_model
def pvt_hugev2_impr1_peg(pretrained=False, **kwargs):
    model = PyramidVisionTransformerImpr_PEG(
        patch_size=4, embed_dims=[128, 256, 512, 768], num_heads=[2, 4, 8, 12], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
