...
srun -p pat_earth -x SH-IDC1-10-198-4-[90-91,100-103,116-119] \
    ...
    --model=mypvt3h2_density0_small --dataset=eft --head_type=hiratt_hmr \
    --name=den0_eft_hiratt  --pretrain_from=data/pretrained/3h2_density0_small.pth\
    --val_dataset=3dpw --resume_from=logs/den0_eft_hiratt/checkpoints/checkpoint_latest.pth
