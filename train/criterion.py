...
class MeshLoss6(nn.Module):
    ...
    def forward(self, pred_para, input_batch, return_vis=False):
        ...
        # sampled_joints_3d = self.smpl.get_train_joints_mine(sampled_vertices)
        sampled_joints_3d = self.smpl.get_joints(sampled_vertices)      # use the train regressor of cmr(different from that used in eval)
        ...
        # sampled_joints_2d = orthographic_projection(sampled_joints_3d, pred_camera)[:, :, :2]
        sampled_joints_2d = proj_2d(sampled_joints_3d, pred_camera)[:, :, :2]
